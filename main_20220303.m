...
% 仿真
expected_obj=evaluate_abs_consider_penalty_new_objective(rep_best_al,REP,rep_best_implement,req,resNumber,best_nrpr,best_pred,best_nrsu,best_su,deadline,resNo,actNo,stochatic_d1,C);
...
% % % 时间
% outResults1=[act,rep_best_implement(actNo+1),cputime,best_al,rep_best_implement,end];
% outFile1=[fpathRoot,num2str(end_time),'s_sch_de_target_ssgs1_',setName,'_dt_',dt,'_',num2str(rep),'.txt'];
