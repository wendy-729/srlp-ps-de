...
% 写入文件路径
fpathRoot=['C:\Users\ASUS\Desktop\测试实验20211014\DE\J',actNumber,'_1','\'];
...
% outFile=[fpathRoot,num2str(end_schedules),'_sch_de_',setName,'_dt_',dt,'_main_vl_decode_value_ssgs_8_',groupdata,'_nolocal_',num2str(rep),'.txt'];
