...
function [expected_obj,time_pro,gap]=evaluate_abs_nopenalty_code1(AL,rep,implement,req,resNumber,nrpr,pred,nrsu,su,deadline,resNo,actNo,stochatic_d,code)
gap = [];
% 满足截止日期的次数
p=0;
% 总的目标函数值
...
for i=1:rep
    d=duration_data(i,:);
%  解码生成进度计划
    [schedule, u_kt] = SSGS_PSGS2(AL,implement,req,resNumber,d,nrpr,pred,deadline,resNo,actNo,code);  
    % 原来的解码
